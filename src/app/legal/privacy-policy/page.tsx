      ...
      <div id="wbars">
        <div className="iub_content legal_pp">
          ...
          <div className="iub_header">
            <h1 className="title">Privacy Policy di <strong>www.goinupvertical.it</strong></h1>
          ...
          <div className="one_line_col">
            ...
            <p>Goinup</p>
            <p><strong>Indirizzo email del Titolare:</strong> matteo.gadola@teeva.it</p>
          </div>
      ...
      <ul className="for_boxes">
          ...
          <li>
            <div className="box_primary box_10 expand">
              <h3 className="expand-click w_icon_24 policyicon_purpose_10801286 iub-purpose iub-purpose-10801286">
...
Questi servizi potrebbero inoltre consentire di raccogliere dati relativi alla data e all&apos;ora di visualizzazione dei messaggi da parte dell&apos;Utente, così come all&apos;interazione dell'Utente con essi, come le informazioni sui click sui collegamenti inseriti nei messaggi.</p>
                  ...
                  <p>Luogo del trattamento:  Francia &ndash;  <a href="https://www.mailjet.com/privacy-policy/" target="_blank" rel="noopener noreferrer">Privacy Policy</a>. </p>
          ...
          <li>
            <div className="box_primary box_10 expand">
              <h3 className="expand-click w_icon_24 policyicon_purpose_10801266 iub-purpose iub-purpose-10801266">
...
<p>Alcuni servizi tra quelli elencati di seguito, se presenti, possono funzionare su server geograficamente distribuiti, rendendo difficile determinare l'effettiva ubicazione in cui sono conservati i Dati Personali.</p>
                  ...
                  <div className="wrap">
                    ...
                    <p>Dati Personali trattati: Dati comunicati durante l&#39;utilizzo del servizio; email; numero di telefono; varie tipologie di Dati secondo quanto specificato dalla privacy policy del servizio.</p>
          ...
          <li>
            <div className="box_primary box_10 expand">
              <h3 className="expand-click w_icon_24 policyicon_purpose_10801357 iub-purpose iub-purpose-10801357">
...
Alcuni dei servizi di seguito indicati potrebbero raccogliere Dati Personali anche per fini di targeting e profilazione; per saperne di più, si prega di fare riferimento alla descrizione di ciascun servizio.</p>
                  ...
                  <h4 className="iub-service iub-service-9228626">Firebase Authentication (Google Ireland Limited)</h4>
                  <div className="wrap">
