  ...
  return (
    <Box h="100vh">
      <section className="relative -top-20 w-full h-full min-h-[600px] overflow-hidden bg-gray-900">
        ...
        <div className="relative z-10 flex flex-col mt-[100px] lg:mt-[150px] px-2 text-primary sm:px-4 lg:px-6 max-w-6xl mx-auto">

          <h1 className="flex flex-col text-center uppercase font-archivo">
            ...
            <ScrollAnimation animation="slide-left" delay={0.12}>
              <span className=" text-5xl lg:text-6xl text-primary">
          ...
          <span className="mt-8 max-w-2xl mx-auto text font-semibold text-primary text-center">
