    ...
    <>
      <article className="px-4 py-8" id="privacy-body">
        ...
        <section id="principles">
          ...
          I dati degli utenti vengono utilizzati unicamente per fornire i servizi richiesti.
          Per riassumere in modo chiaro e sintetico quanto poi scritto di seguito abbiamo riassunto di seguito un riepilogo.
        </section>
