...
export default function HeaderUserButton({ user, className }: { user: User | null, className?: string }) {
    ...
    <Menu shadow="md">
      <Menu.Target>
        <UnstyledButton className="hover:scale-105">
          <Avatar src={user.user_metadata.avatar_url} variant="transparent" size="lg" />
        </UnstyledButton>
      </Menu.Target>
      <Menu.Dropdown>
